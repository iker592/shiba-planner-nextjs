  ...
  return (
    <div className="fixed z-50 left-4 bottom-4">
      <div className="relative group">
        <div className="bg-amber-400 p-3 rounded-full shadow-lg transition-transform duration-300 hover:scale-110">
          <Dog className="w-6 h-6 text-white" />
        </div>
        
        <div className="absolute left-full ml-2 bottom-0 w-48">
